...
public class CrafterController : MonoBehaviour 
{
	...
	public enum CharacterState {Idle, Item, Box, Fishing, Hammer, Digging, Chopping, Food, Drink, Axe, Shovel, FishingPole, Saw, Sawing, PickAxe, PickAxing, Sickle, Rake, Raking, Sit, Climb, PushPull, Lumber};
